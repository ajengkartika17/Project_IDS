var size = 0;
var placement = 'point';
function categories_Kepadatan_1(feature, value, size, resolution, labelText,
                       labelFont, labelFill) {
                switch(value.toString()) {case 'Rendah':
                    return [ new ol.style.Style({
        stroke: new ol.style.Stroke({color: 'rgba(0,0,0,0.0)', lineDash: null, lineCap: 'butt', lineJoin: 'miter', width: 0}), fill: new ol.style.Fill({color: 'rgba(106,198,125,1.0)'}),
...
var style_Kepadatan_1 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
...
var style = categories_Kepadatan_1(feature, value, size, resolution, labelText,
                          labelFont, labelFill);
